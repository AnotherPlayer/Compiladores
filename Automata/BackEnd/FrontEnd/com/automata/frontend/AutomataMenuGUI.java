...
public class AutomataMenuGUI extends JFrame {
    ...
    // JComboBoxes para las operaciones, se mantendrán como miembros de la clase para poder actualizarlos
    ...
    private void createMenuBar() {
        ...
        String[] menuNames = {"Archivo", "Inicio", "Herramientas", "Ayuda"};
        String[] iconNames = {"archivo.png", "inicio.png", "herramientas.png", "ayuda.png"};
        ...
        for (int i = 0; i < menuNames.length; i++) {
            ...
            ImageIcon icon = loadIcon(iconNames[i]);
            if (icon != null) {
                menu.setIcon(icon);
            }
        ...
        button.addActionListener(e -> {
            if (cardName != null && !cardName.isEmpty()) {
                ...
                if (dialogContent != null) {
                    showAutomataDialog(text, dialogContent);
                }
            }
        });
    ...
    private JPanel createAFNPanel() {
        ...
        btnCrear.addActionListener(e -> {
            ...
            if (automataName.isEmpty()) {
                ...
                updateAutomataLists(); // Actualiza los JComboBox
    ...
    private void toggleSidebar() {
        ...
        panelLateral.setVisible(sidebarVisible);

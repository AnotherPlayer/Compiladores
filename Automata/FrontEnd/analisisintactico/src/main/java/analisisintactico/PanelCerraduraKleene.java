...
public class PanelCerraduraKleene extends JPanel {
    ...
    public PanelCerraduraKleene(List<String> currentAfnNames) {
        ...
        add(tituloPanel("Operación: Cerradura de Kleene (*)"));
        ...
        JButton btnAplicar = botonAzul("Aplicar Cerradura Kleene");
        btnAplicar.addActionListener((ActionEvent e) -> {
            ...
            JOptionPane.showMessageDialog(this, 
                "Cerradura de Kleene aplicada. AFN creado: '" + nombreUsuario + "'." + tokenMsg,

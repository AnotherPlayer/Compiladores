...
public class PanelERtoAFN extends JPanel {
    ...
    private void inicializarComponentes() {
        ...
        lblIdAFD.setFont(new Font("Arial", Font.PLAIN, 13));
        panelPrincipal.add(lblIdAFD, gbc);
        
        gbc.gridx = 1;
        gbc.gridy = row++;
        txtIdAFD = new JTextField(25);
        txtIdAFD.setFont(new Font("Arial", Font.PLAIN, 13));
        txtIdAFD.setPreferredSize(new Dimension(300, 28));
        ...
        btnSeleccionarArchivo.setFont(new Font("Arial", Font.PLAIN, 12));
        btnSeleccionarArchivo.setPreferredSize(new Dimension(220, 30));
        ...
        lblExpresionRegular.setFont(new Font("Arial", Font.PLAIN, 13));
        panelPrincipal.add(lblExpresionRegular, gbc);
        
        gbc.gridx = 1;
        gbc.gridy = row++;
        txtExpresionRegular = new JTextField(20);
        txtExpresionRegular.setFont(new Font("Arial", Font.PLAIN, 12));
        txtExpresionRegular.setPreferredSize(new Dimension(250, 25));
        ...
        lblIdParaAFN.setFont(new Font("Arial", Font.PLAIN, 13));
        panelPrincipal.add(lblIdParaAFN, gbc);
        
        gbc.gridx = 1;
        gbc.gridy = row++;
        txtIdParaAFN = new JTextField(25);
        txtIdParaAFN.setFont(new Font("Arial", Font.PLAIN, 13));
        txtIdParaAFN.setPreferredSize(new Dimension(300, 28));
        ...
        btnCrearAFN.setFont(new Font("Arial", Font.BOLD, 12));
        btnCrearAFN.setPreferredSize(new Dimension(130, 32));
